...
const DEST_PATH = __dirname + "/java";
const url = "https://github.com/Tyrbok/Android-Starter-Java.git";
...
clone(url, TEMP_PATH)
    .then(function (repo) {
        ...
        replace({
            regex: 'org.onepointzero.androidstarterjava',
